"""Official-train counterpart of `score_local_attribution_present_vs_
complete.py` -- same present-only vs. complete-set rho comparison, just
pointed at the official-train classifier's own present/absent CSVs and
TASKS=["Attractive","Male"] instead of ["Attractive","Young"]. See that
script's own docstring for the full design rationale.
"""
...
def main():
    ...
    print("\n=== rho: present-only vs. complete set (present + absent), per task per method (official-train classifier) ===")
