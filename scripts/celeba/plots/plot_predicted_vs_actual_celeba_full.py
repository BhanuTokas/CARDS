"""Phase 7 scale-up of the CelebA plan: predicted vs. actual concept
importance scatter plots for ALL 26 groundable concepts -- extends
plot_predicted_vs_actual_celeba.py's own 8-concept pilot plot (v71) the
same way. Logic (2-row x 3-col grid, aggregation via the shared
_aggregate_faithfulness_pairs helper, green/red sign-agreement coloring)
is IDENTICAL, see that script's own docstring; only the input CSVs/
checkpoint paths and n=26 pair count differ.
"""
...
OUT_PATH = RESULTS_DIR / "predicted_vs_actual_celeba_full.png"
